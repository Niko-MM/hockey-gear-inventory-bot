...
- Управление в сервисе: модели, цвета, флекс, загиб, хват (заготовки для конструктора поступления)
...
Дальше: поступление и продажа (конструктор из этих заготовок), остатки и бухгалтерия.
